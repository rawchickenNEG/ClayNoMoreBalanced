...
import io.github.rawchickenneg.cnmb.common.entity.ThrownEnderClayBall;
...
public class EnderClayBall extends Item {
    public EnderClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownEnderClayBall clayball = new ThrownEnderClayBall(level, player);
