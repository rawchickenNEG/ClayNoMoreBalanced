...
import io.github.rawchickenneg.cnmb.common.entity.ThrownPullClayBall;
...
public class PullClayBall extends Item {
    public PullClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownPullClayBall clayball = new ThrownPullClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.PULL.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.pull_clay_ball.tip").withStyle(ChatFormatting.GREEN));
