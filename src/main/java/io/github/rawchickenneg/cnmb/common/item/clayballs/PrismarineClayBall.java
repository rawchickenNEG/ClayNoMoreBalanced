...
import io.github.rawchickenneg.cnmb.common.entity.ThrownPrismarineClayBall;
...
public class PrismarineClayBall extends Item {
    public PrismarineClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownPrismarineClayBall clayball = new ThrownPrismarineClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.PRISMARINE.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.prismarine_clay_ball.tip").withStyle(ChatFormatting.DARK_AQUA));
