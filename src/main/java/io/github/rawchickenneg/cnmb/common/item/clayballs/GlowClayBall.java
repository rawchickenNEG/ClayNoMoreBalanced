...
import io.github.rawchickenneg.cnmb.common.entity.ThrownGlowClayBall;
...
public class GlowClayBall extends Item {
    public GlowClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownGlowClayBall clayball = new ThrownGlowClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.GLOW.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.glow_clay_ball.tip").withStyle(ChatFormatting.AQUA));
