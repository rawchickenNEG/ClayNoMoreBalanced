...
import io.github.rawchickenneg.cnmb.common.entity.ThrownBoneClayBall;
...
public class BoneClayBall extends Item {
    public BoneClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownBoneClayBall clayball = new ThrownBoneClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.BONE.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.bone_clay_ball.tip").withStyle(ChatFormatting.GREEN));
