...
import io.github.rawchickenneg.cnmb.common.entity.ThrownAmethystClayBall;
...
public class EnderSlimeClayBall extends Item {
    public EnderSlimeClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.ender_slime_clay_ball.tip").withStyle(ChatFormatting.DARK_PURPLE));
