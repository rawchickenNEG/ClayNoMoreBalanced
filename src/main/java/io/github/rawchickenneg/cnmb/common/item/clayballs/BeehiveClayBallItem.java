...
import io.github.rawchickenneg.cnmb.common.entity.ThrownBeehiveClayBall;
...
public class BeehiveClayBallItem extends Item {
    public BeehiveClayBallItem(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownBeehiveClayBall clayball = new ThrownBeehiveClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.HONEY.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.honey_clay_ball.tip").withStyle(ChatFormatting.YELLOW));
