...
import io.github.rawchickenneg.cnmb.common.entity.ThrownLeavesClayBall;
...
public class LeavesClayBall extends Item {
    public LeavesClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownLeavesClayBall clayball = new ThrownLeavesClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.LEAVES.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.leaves_clay_ball.tip").withStyle(ChatFormatting.DARK_GREEN));
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.leaves_clay_ball.tip2").withStyle(ChatFormatting.GRAY));
