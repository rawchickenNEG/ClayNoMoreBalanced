...
import io.github.rawchickenneg.cnmb.common.entity.ThrownEggClayBall;
...
public class EggClayBall extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownEggClayBall clayball = new ThrownEggClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.EGG.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.egg_clay_ball.tip").withStyle(ChatFormatting.YELLOW));
