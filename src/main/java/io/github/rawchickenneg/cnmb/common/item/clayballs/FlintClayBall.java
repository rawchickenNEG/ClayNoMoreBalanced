...
import io.github.rawchickenneg.cnmb.common.entity.ThrownFlintClayBall;
...
public class FlintClayBall extends Item {
    public FlintClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownFlintClayBall clayball = new ThrownFlintClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.FLINT.get());
