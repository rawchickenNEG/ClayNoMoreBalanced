...
import io.github.rawchickenneg.cnmb.common.entity.ThrownBurnClayBall;
...
public class BurnClayBallItem extends Item {
    public BurnClayBallItem(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownBurnClayBall clayball = new ThrownBurnClayBall(level, player);
