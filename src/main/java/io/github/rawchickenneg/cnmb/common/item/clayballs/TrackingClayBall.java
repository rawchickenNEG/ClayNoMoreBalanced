...
import io.github.rawchickenneg.cnmb.common.entity.ThrownTrackingClayBall;
...
public class TrackingClayBall extends Item {

    public TrackingClayBall(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownTrackingClayBall clayBall = new ThrownTrackingClayBall(player, level);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag isAdvanced) {
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.tracking_clay_ball.tip").withStyle(ChatFormatting.GREEN));
