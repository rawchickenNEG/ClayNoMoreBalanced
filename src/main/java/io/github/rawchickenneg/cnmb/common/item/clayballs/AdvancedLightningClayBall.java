...
public class AdvancedLightningClayBall extends Item {

    public AdvancedLightningClayBall(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownAdvancedLightningClayBall clayBall = new ThrownAdvancedLightningClayBall(player, level);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag isAdvanced) {
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.advanced_lightning_clay_ball.tip").withStyle(ChatFormatting.AQUA));
