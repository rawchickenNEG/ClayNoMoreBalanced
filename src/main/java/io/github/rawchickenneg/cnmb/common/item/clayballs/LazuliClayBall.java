...
import io.github.rawchickenneg.cnmb.common.entity.ThrownLazuliClayBall;
...
public class LazuliClayBall extends Item {
    public LazuliClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownLazuliClayBall clayball = new ThrownLazuliClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.LAZULI.get());
