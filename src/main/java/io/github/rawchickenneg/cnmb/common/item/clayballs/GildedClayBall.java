...
import io.github.rawchickenneg.cnmb.common.entity.ThrownGildedClayBall;
...
public class GildedClayBall extends Item {
    public GildedClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownGildedClayBall clayball = new ThrownGildedClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.GILDED.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.gilded_clay_ball.tip").withStyle(ChatFormatting.YELLOW));
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.gilded_clay_ball.tip2").withStyle(ChatFormatting.GRAY));
