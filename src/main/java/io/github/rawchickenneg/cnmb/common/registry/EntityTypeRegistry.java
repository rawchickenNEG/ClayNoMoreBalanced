...
public class EntityTypeRegistry {
    ...
    public static final RegistryObject<EntityType<ThrownVehicleClayBall>> THROWN_VEHICLE_CLAY_BALL = throwableItem("vehicle_clay_ball", ThrownVehicleClayBall::new);
