...
import io.github.rawchickenneg.cnmb.common.entity.ThrownCactusClayBall;
...
public class CactusClayBallItem extends Item {
    public CactusClayBallItem(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownCactusClayBall clayball = new ThrownCactusClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.CACTUS.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.cactus_clay_ball.tip").withStyle(ChatFormatting.RED));
