...
import io.github.rawchickenneg.cnmd.common.entity.ThrownGoldenClayBall;
...
public class GoldenClayBall extends Item {
    public GoldenClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownGoldenClayBall clayball = new ThrownGoldenClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.GOLDEN.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.golden_clay_ball.tip").withStyle(ChatFormatting.GOLD));
