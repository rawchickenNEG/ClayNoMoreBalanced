...
import io.github.rawchickenneg.cnmd.common.entity.ThrownClayBallFromBow;
        ...
        if (p_40669_ instanceof Player) {
            ...
            int i = this.getUseDuration(p_40667_) - p_40670_;
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    p_40668_.playSound(null, player.getX(), player.getY(), player.getZ(), SoundEvents.SNOWBALL_THROW, SoundSource.PLAYERS, 1.0F, 1.0F / (p_40668_.getRandom().nextFloat() * 0.4F + 1.2F) + f * 0.5F);
