...
import io.github.rawchickenneg.cnmd.common.entity.ThrownDryClayBall;
...
public class DryClayBall extends Item {
    public DryClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownDryClayBall clayball = new ThrownDryClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.DRY.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.dry_clay_ball.tip").withStyle(ChatFormatting.GRAY));
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.dry_clay_ball.tip2").withStyle(ChatFormatting.GRAY));
