...
import io.github.rawchickenneg.cnmd.common.entity.ThrownStoneClayBall;
...
public class StoneClayBall extends Item {
    public StoneClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownStoneClayBall clayball = new ThrownStoneClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.STONE.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.stone_clay_ball.tip").withStyle(ChatFormatting.YELLOW));
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.stone_clay_ball.tip2").withStyle(ChatFormatting.GRAY));
