...
import io.github.rawchickenneg.cnmd.common.entity.ThrownObsidianClayBall;
...
public class ObsidianClayBall extends Item {
    public ObsidianClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownObsidianClayBall clayball = new ThrownObsidianClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.OBSIDIAN.get());
