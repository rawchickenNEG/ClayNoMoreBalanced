...
import io.github.rawchickenneg.cnmd.common.entity.ThrownPillagerClayBall;
...
public class PillagerClayBall extends Item {
    public PillagerClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownPillagerClayBall clayball = new ThrownPillagerClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.PILLAGER.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.pillager_clay_ball.tip").withStyle(ChatFormatting.RED));
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.pillager_clay_ball.tip2").withStyle(ChatFormatting.DARK_RED));
