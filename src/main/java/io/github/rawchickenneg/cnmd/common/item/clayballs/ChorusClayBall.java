...
import io.github.rawchickenneg.cnmd.common.entity.ThrownChorusClayBall;
...
public class ChorusClayBall extends Item {
    public ChorusClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownChorusClayBall clayball = new ThrownChorusClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.CHORUS.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.chorus_clay_ball.tip").withStyle(ChatFormatting.DARK_PURPLE));
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.chorus_clay_ball.tip2").withStyle(ChatFormatting.DARK_AQUA));
