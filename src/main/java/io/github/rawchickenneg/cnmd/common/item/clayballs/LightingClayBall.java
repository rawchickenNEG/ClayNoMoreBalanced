...
import io.github.rawchickenneg.cnmd.common.entity.ThrownLightingClayBall;
...
public class LightingClayBall extends Item {
    public LightingClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownLightingClayBall clayball = new ThrownLightingClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.LIGHTING.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.lighting_clay_ball.tip").withStyle(ChatFormatting.YELLOW));
