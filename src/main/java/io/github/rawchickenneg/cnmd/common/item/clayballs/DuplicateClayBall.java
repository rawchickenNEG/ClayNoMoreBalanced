...
import io.github.rawchickenneg.cnmd.common.entity.ThrownDuplicateClayBall;
...
public class DuplicateClayBall extends Item {
    public DuplicateClayBall(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownDuplicateClayBall clayball = new ThrownDuplicateClayBall(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.DUPLICATE.get());
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.duplicate_clay_ball.tip").withStyle(ChatFormatting.DARK_PURPLE));
        tooltip.add(new TranslatableComponent("item.clay_no_more_balanced.duplicate_clay_ball.tip2").withStyle(ChatFormatting.GRAY));
