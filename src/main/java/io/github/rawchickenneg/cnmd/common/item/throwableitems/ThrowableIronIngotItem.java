...
import io.github.rawchickenneg.cnmd.common.entity.ThrownIronIngot;
...
public class ThrowableIronIngotItem extends Item {
    public ThrowableIronIngotItem(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownIronIngot clayball = new ThrownIronIngot(level, player);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        String damage = String.valueOf(Config.CONFIG.IRON.get());
